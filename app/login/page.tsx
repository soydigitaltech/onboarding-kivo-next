  ...
  return (
    <main className="flex min-h-dvh w-full flex-col items-center justify-center px-4 py-10 sm:px-6">
      ...
      <motion.div
        ...
        className="mt-7 w-full max-w-md rounded-[28px] bg-white p-6 shadow-[0_18px_50px_rgba(11,23,57,0.16)] sm:p-8"
      >
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="mt-2 inline-flex min-h-12 w-full items-center justify-center rounded-xl bg-accent px-6 text-[15px] font-bold text-white transition-colors hover:brightness-105 shadow-[0_12px_24px_-14px_rgba(254,152,6,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
