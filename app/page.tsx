...
export default function LandingPage() {
 ...
 {/* Card */}
 <div className="rounded-2xl bg-white p-7 text-center sm:p-9">
 ...
 <Link
 href="/onboarding"
 className="mt-6 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-accent px-6 text-[15px] font-bold text-white transition-colors hover:brightness-105 "
 >
 Regístrate gratis
