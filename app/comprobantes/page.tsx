...
export default function ComprobantesPage() {
 return (
 <AppShell subtitulo="Historial de pagos y comprobantes">
 ...
 Aquí podrás consultar, descargar y verificar los comprobantes de tus
 pagos.
 </p>
 ...
 Próximamente agregaremos filtros, fechas y descarga de archivos.
 </p>
 </div>
 </section>
 </AppShell>
